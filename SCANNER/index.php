      ...
      <section class="scanner-viewport-section" id="scannerInputSection">
        <div class="rupantara-scanner-card">
          <div class="scanner-card-header">
            ...
            <p class="scanner-subtitle">Unggah gambar/foto uang Rupiah untuk memindai pecahan, pahlawan, dan keaslian 3D.</p>
          </div>
          ...
          <!-- KONTROL SCANNER (Upload Foto Uang) -->
          <div class="scanner-controls-panel">
            <div class="control-buttons flex flex-wrap gap-4 justify-center">
              <label class="btn btn-primary-sm file-upload-label cursor-pointer">
